...
#class WatchlistTestCase(unittest.TestCase):
    ...
    def test_admin_command(self):
        ...
        self.assertTrue(check_password_hash(User.query.first().password_hash, '123'))
    ...
    def test_admin_command_update(self):
        ...
        self.assertTrue(check_password_hash(User.query.first().password_hash, '456'))
